/**
  ...
  * \version 1.1.0
  * \date    1.08.2017
  * \brief   Пример проекта для выполнения лабораторной работы №1.
    ...
    for (;;)
    {
        ...
        else
        {
            /* Если при вводе строки вместо ожидаемого беззнакового числа введена,
               ...
               необходимо нажать комбинацию клавишь Ctrl - J. Поэтому для
               удобства в примерах лабораторных работ для микроконтроллеров

...
- знакомство с микроконтроллером `К1986ВЕ92QI` (`MDR32F9Q2I`) компании Миландр
...
- `labs` - примеры лабораторных работ
  ...
  - `lab3_ex` - пример лабораторной работы №3, в которой изучается модуль цифро-аналогового преобразователя

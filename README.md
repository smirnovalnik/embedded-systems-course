...
- Лекции
  ...
  - Лекция №8: Периферийные модули: Timer, DMA, ADC, DAC ([слайды](./lectures/lect_8.pdf))
  - Лекция №9: Периферийные модули: USB, Ethernet ([слайды](./lectures/lect_9.pdf))
- Лабораторные работы
...
Список вопросов для защиты приведен здесь [labs/lab_quastions](./labs/lab_questions.md).
